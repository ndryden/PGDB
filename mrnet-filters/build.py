...
build_command = "g++ -Wall -Wextra -O0 -g -I" + mrnet_path + "/include -L" + mrnet_path + "/lib -Wl,-rpath=" + mrnet_path + "/lib -fPIC -shared -rdynamic -o arec_filter.so arec_filter.cc -lmrnet -lxplat"
