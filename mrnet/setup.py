...
mrnet = Extension("MRNet",
                  ...
                  libraries=["mrnet", "xplat",
                             "boost_timer-mt", "boost_system-mt"],
                  extra_compile_args=[],
                  extra_link_args=["-Wl,-rpath=" + mrnet_path + "/lib",
                                   "-Wl,-E"])
setup(name="MRNet", version="0.01",
      description="Python interface to MRNet", ext_modules=[mrnet])
