...
The rest of the installation of the bindings makes use of the standard Python distutils installation system. See the relevant Python documentation for full details; a brief overview is provided here. To build the bindings,
...
where \texttt{--prefix prefix} is an optional argument indicating the install location of the bindings.
